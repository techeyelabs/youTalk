				...
				<div class="mt20">
					...
					<section>
						<div class="form-group  row">
							...
							<div class="col-md-8">
								<input type="text" class="form-control required p_title length20" placeholder="" name="title" value="{{ $product->title }}">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
							<img width="200" height="200" src="{{Request::root().'/uploads/products/'.$product->image}}">
							<input type="file" class=" product_image" placeholder="" name="image">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<textarea class="form-control required p_description length200_1 " rows="4" cols="50" name="description">{{ $product->description }}</textarea>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<img width="200" height="200" src="{{Request::root().'/uploads/products/'.$product->product_title_image}}">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<textarea class="form-control required p_details length200_2" rows="4" cols="50" name="explanation">{{ $product->explanation }}</textarea>
						...
						<div class="form-group row">
							<div class="col-md-4"></div>
							<div class="col-md-8">
								<img width="200" height="200" src="{{Request::root().'/uploads/products/'.$product->product_details_images}}">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<input type="text" class="form-control required company_name length20_2" value="{{ $product->company_name }}" name="company_name">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<textarea class="form-control required p_company_info length200_3" rows="4" cols="50" name="company_info">{{ $product->company_info }}</textarea>
						...
						<div class="form-group row">
							<div class="col-md-4"></div>
							<div class="col-md-8">
								<img width="200" height="200" src="{{Request::root().'/uploads/products/'.$product->company_info_image}}">
							...
							<div class=" justify-content-center">
								<div class=" col-md-12 mt-5">
									...
									<div class="row inner_inner">
										<div class="col-md-7 " >
											<div class="product_image" id="new_product_image">
												<img class="" width="100%" height="200" style="object-fit: cover" src="{{Request::root().'/uploads/products/'.$product->image}}">
											</div>
										</div>
											...
											<div class="row ">
												<div class="col-md-12">
													<p><span class="font-weight-bold product_price" style="font-size:23px; letter-spacing:2px;"></span>
														<span class="" style="font-size:20px; letter-spacing:1px;">円</span></p>
												</div>
											</div>
											<div class="row ">
												<div class="col-md-offset-2 col-md-6 mr-0 " style="height:55px; width:80px;">
													<div class="">カラー :</div>
								...
								<div class="mt-5 mb-5 row">
									<div class="mb-3 col-md-8">
										<div class="bg-white ">
											...
											<div class="product_title_image" id="new_product_title_image">
												<img width="100%" height="200" src="{{Request::root().'/uploads/products/'.$product->product_title_image}}">
											</div>
										</div>
										<div class="bg-white ">
											<h4 class="pb-2 font-weight-bold ">商品詳細</h4>
											<p class="product_details"></p>
											<div class="product_deatials_images" id="new_product_details_images">
												<img width="100%" height="200" src="{{Request::root().'/uploads/products/'.$product->product_details_images}}">
											</div>
										</div>
									</div>
									...
									<div class="mb-3 col-md-4">
										<div class="bg-white ">
											...
											<div class="company_info_image" id="new_company_info_image">
												<img width="100%" height="200" src="{{Request::root().'/uploads/products/'.$product->company_info_image}}">
											</div>
										</div>
									</div>
								</div>
	...
	<script type="text/javascript">
		...
		$('.product_image').change(function(){
			if (this.files && this.files[0]) {
				...
				reader.onload = function(e) {
					...
					$('#new_product_image').html('<img width="200" src="'+e.target.result+'">');
				}
		...
		$('.company_info_image').change(function(){
			if (this.files && this.files[0]) {
				...
				reader.onload = function(e) {
					var imgcontent = '<img width="200" src="'+e.target.result+'">';
					$('#new_product_company_image').html('<img width="200" src="'+e.target.result+'">');
				}
				reader.readAsDataURL(this.files[0]);
			}
		});
		...
		$('.product_title_image').change(function(){
			if (this.files && this.files[0]) {
			    ...
			    reader.onload = function(e) {
			    	...
			    	$('#new_product_title_image').html('<img width="100%" height="100"  style="object-fit:cover" src="'+e.target.result+'">');
			    }
			    reader.readAsDataURL(this.files[0]);
			  }
		});
		$('.product_details_images').change(function(){
			if (this.files && this.files[0]) {
			    ...
			    reader.onload = function(e) {
			    	var imgcontent = '<img width="100%" height="100"  style="object-fit:cover" src="'+e.target.result+'">';
			    	$('#new_product_details_images').html('<img width="100%" height="100"  style="object-fit:cover" src="'+e.target.result+'">');
			    }
			    reader.readAsDataURL(this.files[0]);
			  }
		});
